...
const TUTORIALS: Tutorial[] = [
  ...
  },
  {
    ...
    chapters: [
      ...
      { time: "0:40", title: "Dashboard Overview" },
      { time: "0:58", title: "How to Create Inquiry" },
      { time: "2:05", title: "My Inquiries" },
      { time: "3:18", title: "Thank You and Contact Information" },
    ],
  },
  {
    id: "seller",
    ...
    chapters: [
      { time: "0:00", title: "Welcome to DND Purchase" },
      { time: "0:08", title: "Setting up your Seller profile" },
      { time: "1:08", title: "Setting up My Products" },
      { time: "1:45", title: "Dashboard Overview" },
      { time: "2:05", title: "New Inquiry" },
      { time: "2:37", title: "My Offers" },
      { time: "3:05", title: "Thank You and Contact Information" },
    ],
  },
]
